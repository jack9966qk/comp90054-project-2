...
class DummyAgent(CaptureAgent):
    ...
    def chooseAction(self, gameState):
        if self.prevState:
            print("record step")
            r = reward.getReward(self, gameState, self.prevState, False)
            self.recorder.recordStep(self, gameState,
                                     self.prevState,
                                     self.prevAction, r,
                                     {"mode": self.prevMode})
    ...
    def final(self, gameState):
        if self.prevState:
            print("record final step")
            r = reward.getReward(self, gameState, self.prevState, False)
            self.recorder.recordFinalStep(self, gameState,
                                     self.prevState,
                                     self.prevAction, r,
                                     {"mode": self.prevMode})
